...
export const Testimonial: React.FC<TestimonialComponentProps> = ({ imgSrc, title, text }) => (
  <Col>
    <Card className="h-100 shadow" style={{backgroundColor: '#090F15', color: 'white'}} data-testid="testimonial">
      <Card.Img variant="bottom" src={imgSrc} style={{margin: '1rem', width: '8rem'}} alt="Customer of Sidekick"/>
      <Card.Body>
